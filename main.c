...
int main() {
  ...
  if (strcmp("50->40->30->20->10->60->70->80->NULL", listToString(mylist)) != 0) {
  ...
  list_add_at_index(mylist, 100, 4);
  list_add_at_index(mylist, 200, 7);

  if (strcmp("50->40->30->20->100->10->60->200->70->80->NULL", listToString(mylist)) != 0) {
  ...
  if (strcmp("40->30->20->100->10->60->200->70->80->NULL", listToString(mylist)) != 0) {
  ...
  if (strcmp("40->30->20->100->10->60->200->70->NULL", listToString(mylist)) != 0) {
  ...
  if (strcmp("40->30->100->10->60->70->NULL", listToString(mylist)) != 0) {
    printf("list_remove_at_index : FAILED\n");
  }
  ...
  if (list_is_in(mylist, 50)) {
    printf("list_is_in : FAILED\n");
  }

  // Test list_get_elem_at
  if (list_get_elem_at(mylist, 3) != 10) {
  ...
  if (list_get_index_of(mylist, 50) != -1) {
    printf("list_get_index_of : FAILED\n");
  }
